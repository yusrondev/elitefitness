    ...
    <div id="main-wrapper">
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
			    <form action="{{ route('admin.reportactive') }}" method="GET">
                    <div class="row mb-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            ...
                            <a href="{{ route('admin.reportactivePDF', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}" class="btn btn-danger ms-2" target="_blank">Cetak Excel</a>
                        </div>
                    </div>
                </form>
                <div class="card">
