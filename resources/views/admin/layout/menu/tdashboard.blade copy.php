...
<head>
	...
	<style>
		#calendar {
			width: 100%;
			max-height: 500px; /* Mengatur tinggi maksimal kalender */
			overflow: auto; /* Agar jika terlalu tinggi, ada scroll */
			box-sizing: border-box;
			margin: 0;
		}

		.fc {
			font-size: 14px; /* Ukuran font tanggal dan judul lebih besar */
		}

		.fc-toolbar {
			margin-bottom: 10px; /* Memberikan jarak antara toolbar dan kalender */
		}

		.fc-day-header {
			font-size: 16px; /* Ukuran font untuk hari-hari lebih besar */
		}
				...
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
						<i class="fas fa-info-circle"></i>
							<span class="nav-text">Informasi Gym</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="app-profile.html">Asset</a></li>
							<li><a href="app-profile.html">Keuangan</a></li>
                        </ul>
                    </li>
                </ul>
			</div>
